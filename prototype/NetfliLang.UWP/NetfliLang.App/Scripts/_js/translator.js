...
define("services/translator.service", ["require", "exports", "services/mutation-observer.service", "../models/netfli-lang", "helpers/try-safe"], function (require, exports, mutation_observer_service_1, netfli_lang_1, try_safe_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class TranslatorService extends mutation_observer_service_1.MutationObserverService {
    }
    exports.TranslatorService = TranslatorService;
    class GTranslatorService extends TranslatorService {
        constructor() {
            super();
            this.onNodeAdded = (node, key, parent) => {
        ...
        get source() {
            return try_safe_1.trySafe(() => document.querySelector('#source'));
        }
        get sourceText() {
            return try_safe_1.trySafe(() => this.source.value);
        }
        get resultText() {
            return try_safe_1.trySafe(() => {
                let result = '';
                document.querySelectorAll('.tlid-result .tlid-translation').forEach((r) => result += r.textContent);
                return result;
            });
        }
        translate(value) {
...
define("translator", ["require", "exports", "services/translator.service"], function (require, exports, translator_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const translator = new translator_service_1.GTranslatorService();
