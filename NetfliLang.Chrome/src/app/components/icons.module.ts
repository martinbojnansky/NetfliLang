...
export class GTranslateIconComponent extends IconComponent {}

@NgModule({
  declarations: [GTranslateIconComponent],
  exports: [GTranslateIconComponent],
})
